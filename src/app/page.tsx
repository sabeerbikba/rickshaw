      ...
      <main className="main-home">
         ...
         <div className="content">
            <div className="light-left">
               <svg
                  className="light light-left-svg"
                  viewBox="0 0 328 333"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
               >
            ...
            <div className="light-right">
               <svg
                  className="light light-right-svg"
                  viewBox="0 0 328 333"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
               >
         ...
         <div className="road">
            ...
            >
               <g id="road3-1">
                  ...
                  <path
                     id="Rectangle 21"
                     d="M366 0H403V52C403 55.866 399.866 59 396 59H373C369.134 59 366 55.866 366 52V0Z"
                     fill="black"
                  />
                  <path
                     id="Rectangle 22"
                     d="M27 0H64V52C64 55.866 60.866 59 57 59H34C30.134 59 27 55.866 27 52V0Z"
                     fill="black"
                  />
                  <path
                     id="Rectangle 19"
                     d="M206 0.00195312H224L228.208 125.127H214H201.777L206 0.00195312Z"
                     fill="#DEDEDE"
                  />
               </g>
            </svg>
            ...
            >
               <g id="road3-2">
                  ...
                  <path
                     id="Rectangle 20"
                     d="M200.274 0.751953H229.711L235 157.5H195L200.274 0.751953Z"
                     fill="#D9D9D9"
                  />
               </g>
            </svg>
            ...
            >
               <g id="road3-3">
                  <rect id="Rectangle 18" width={430} height={166} fill="#575757" />
                  <path
                     id="Rectangle 21"
                     d="M193.5 36H236.5L241 169H189L193.5 36Z"
                     fill="#D9D9D9"
                  />
               </g>
            </svg>
