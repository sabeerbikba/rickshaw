...
const FALLBACK_PLACEHOLDER: string = // TODO: this is not good one use better one i think test.png image is better option 
...
const FALLBACK_IMG: string = '/images/test.png'; // i think better to use base64String
