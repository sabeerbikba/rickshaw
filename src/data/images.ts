...
type ImageType = ImgDimesionsTypes & {
   ...
   fallbackSrc1?: string;
   fallbackSrc2?: string;
   // blurhash: string; // not using for now 
...
const FALLBACK_PLACEHOLDER: string =
   ...
   'data:image/webp;base64,UklGRqIAAABXRUJQVlA4WAoAAAAQAAAADwAADgAAQUxQSEIAAAARL6AWkiQ4KrHxht8dwBFcRMRTiwOrSLIaDUFA/ofFEfh3k+4cRPQ/+ReAnmAWkAyrgoZheggRmuEd4maCktRl+AxWUDggOgAAAJABAJ0BKhAADwAFQHwlmAJ0AHLURgDTlb46xt7g6XOjPZA+rKqnff7eZ2NL9bTOpaV/2ClIZsnYYAA='
const FALLBACK_IMG: string = '/images/failed-to-load-image.jpg';
const FALLBACK_IMG_DIMENSIONS: ImgDimesionsTypes = {
   width: 380,
   height: 350,
};
...
const images: ImageType[] = [{
   ...
   base64String: 'data:image/webp;base64,UklGRlQAAABXRUJQVlA4IEgAAADwAQCdASoQAAwABUB8JbAC7ADhZY4chIAA4eH98LRq5wPnPzDDXWmqyvO0lE2smRtXe9i0z11Xl3QqMRb0rqQBbNJcol/wAAA=',
   width: 1024,
   height: 767,
   // isLarage: false,
   // size: '174KB',
   ...
   base64String: 'data:image/webp;base64,UklGRkwAAABXRUJQVlA4IEAAAADQAQCdASoQAAoABUB8JbACdAEPFHCggAD+6uxq5337njcRk3idTPdmgV2VVTOtMKsf6XvFmn4a4N3qJe7fAAAA',
   width: 700,
   height: 443,
   // isLarage: false,
   // size: '40KB',
   ...
   base64String: 'data:image/webp;base64,UklGRk4AAABXRUJQVlA4IEIAAAAQAgCdASoQAAwABUB8JbACdH8AE4h/s7gAAMyZ8eMqJ0UGTXo3/ARc+jpQdg+HaJlh6h7V5oGGHGGIcpfBh9WtAAA=',
...
// {
//    id: 5,
//    src: "https://i.imgur.com/G4vcSYV.jpe",
//    fallbackSrc1: "https://i.ibb.co/L0jspcM/G4vcSYV.jp",
//    fallbackSrc2: "/images/G4vcSYV.jp",
...
//    base64String: 'data:image/webp;base64,UklGRlAAAABXRUJQVlA4IEQAAACwAQCdASoQAAwABUB8JYgCdABwZ3jAAP1omtcrQAepw6m1DpU0upLb3Gl/chhfkHazSXtHPzjbbkNDkcNHkIJDMgAAAA==',
//    width: 4608,
//    height: 3456,
//    // isLarage: true,
//    // size: '3.1MB',
// }
{
   ...
   base64String: 'data:image/webp;base64,UklGRloAAABXRUJQVlA4IE4AAAAwAgCdASoQABAABUB8JYgCsIExDgoatAY1kAD+q7B8F4RE1xkTYkC66TJ+683mK4Vnfs1U0CFmx3DL0o1Ovd3TaIp9S8Vn/yhCJDufgAA=',
   width: 200,
   height: 200,
   // isLarage: false,
   // size: '11KB',
...

{
   ...
   base64String: 'data:image/webp;base64,UklGRkQAAABXRUJQVlA4IDgAAAAQAgCdASoNABAABUB8JbAC7OUABoIUJ7UAAMsOstpKxcrbBOMm+7b7kE27Y0/822BJTP5TWgAAAA==',
   width: 600,
   height: 750,
   // isLarage: false,
   // size : 99KB,
   ...
   base64String: 'data:image/webp;base64,UklGRlYAAABXRUJQVlA4IEoAAAAQAgCdASoHABAABUB8JbACdADdZGJfzlwAAP0kARdVI4xwG0G/xMS7JTVKCq7MI1o2JmNFEKuu+bpuvrbaVNPe+JGwOBn2z8oAAA==',
   width: 718,
   height: 1600,
   // isLarage: false,
   // size: '175KB',
   ...
   base64String: 'data:image/webp;base64,UklGRk4AAABXRUJQVlA4IEIAAAAQAgCdASoQAAkABUB8JbACdADhYO7CalAAAPqfQZGaBSpreBS2Hv7e9CqCRWtr3dMiDz2aFxjpxNOFn54cdpemAAA=',
   width: 1000,
   height: 563,
   // isLarage: false,
   // size: '102KB',
   ...
   alt: "apsarkonda-in-rainy-season-10",
   ...
   base64String: 'data:image/webp;base64,UklGRmgAAABXRUJQVlA4IFwAAACwAQCdASoQAAsABUB8JbAAAuH4MAgAAP1S0Ze5QYaEqI0jqd+riIrZEQ7XHo1/6dTmM1gR3HCpccP1B442joDriqOJiyddDFk/FkGpe+fuUECDy4rmBR2/J74AAA==',
   width: 1024,
   height: 678,
   // isLarage: false,
   // size: '156KB',
   ...
   base64String: 'data:image/webp;base64,UklGRl4AAABXRUJQVlA4IFIAAADQAQCdASoQAAkABUB8JbACdAEN4YlooAD+qbpD6sBZ1hBcmNxc/GYxLooyakhub26SJd9jB8V3s97tXbkIT0S2HJqGIzwwqBo1A2I2pxIAFgAA',
   width: 1280,
   height: 720,
   // isLarage: false,
   // size: '184KB',
   ...
   base64String: 'data:image/webp;base64,UklGRlgAAABXRUJQVlA4IEwAAADwAQCdASoQAAkABUB8JbACsADw/cpZSAAAzEyiIGAZCIKpTv8kjtHLaIoLTSnNl1l+edmUeXoSFcFWRkRgMTAGb6AWANMAIlAMOAAA',
   width: 1280,
   height: 720,
   // isLarage: false,
   // size: '345KB',
   ...
   base64String: 'data:image/webp;base64,UklGRk4AAABXRUJQVlA4IEIAAAAQAgCdASoQAAwABUB8JbACdH8AEx8FfVAAAP7TfOCWdQAz1vZylhcy+6nsx4JsTDwKqjIV5ZF65Bjk6BrPKnZQAAA=',
   width: 4608,
   height: 3456,
   // isLarage: true,
   // size: '2.5MB',
   ...
   base64String: 'data:image/webp;base64,UklGRkoAAABXRUJQVlA4ID4AAAAQAgCdASoQAAkABUB8JbACdGuAAoad6tAAAPyL2KmZP4oTN01zUqfgcouBePHXyDJh8sLaqDKOr8e6AsAAAA==',
   width: 350,
   height: 200,
   // isLarage: false,
   // size: '19KB',
   ...
   base64String: 'data:image/webp;base64,UklGRlIAAABXRUJQVlA4IEYAAADQAQCdASoQAAoABUB8JbACdAC3xCR8AAD9nSs/KKVFGry8N2kar9T9/+8vka0hCm8usLE90zVkuQQBOmEyQxnStvfS4AAA',
   width: 708,
   height: 452,
   // isLarage: false,
   // size: '63KB',
   ...
   base64String: 'data:image/webp;base64,UklGRk4AAABXRUJQVlA4IEIAAAAQAgCdASoQAAsABUB8JZgC7ADpNdaz8U44AP59ZNEg/hUl9cV03ODAfxdrYpI7ga2AI4/ev/bL6j8C7t74uJAAAAA=',
   width: 800,
   height: 535,
   // isLarage: true,
   // size: '886KB',
   ...
   base64String: 'data:image/webp;base64,UklGRk4AAABXRUJQVlA4IEIAAADwAQCdASoQAAwABUB8JQBOgBTHMPHWGQAA/tmdZD4pRiKkvTcaeJx2CBfdOSA/l6oMG+oOPNMPxVLYbPTx0OOsAAA=',
   width: 4608,
   height: 3456,
   // isLarage: true,
   // size: '1.2MB',
   ...
   alt: "mangrove-boardwalk-front-18",
   ...
   base64String: 'data:image/webp;base64,UklGRlYAAABXRUJQVlA4IEoAAAAQAgCdASoQAAkABUB8JbACdEf/gbtcv6dgAPvENCG8WFutukpxfPQnixfbygJ0WHCq+eDYm+hD/QPma2rGIbzY/jE6qO0dbsAAAA==',
   width: 686,
   height: 386,
   // isLarage: false,
   // size: '87KB',
   ...
   base64String: 'data:image/webp;base64,UklGRlAAAABXRUJQVlA4IEQAAADwAQCdASoQAAwABUB8JZgCdAEVwxtYcgAA/iUgbxUX75aTEN0Pe68u2Le/TPVeirLRqvb1bMyEHKjqXHxgMAgEMyAAAA==',
   width: 718,
   height: 517,
   // isLarage: false,
   // size: '53KB',
